...
test('nominations component', () => {
    ...
    const removeNominationHandler = (id: string) => {
        nominatedMovies = nominatedMovies.filter((movie: movieInterface) => movie.imdbID !== id)
    }
    ...
    const titleElement = screen.getByRole('heading', {name: /The Mitchells vs. the Machine/i});
